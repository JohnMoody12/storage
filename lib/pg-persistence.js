...
//   async createTodo(todoListId, title, user) {
//     const CREATE_TODO =
//       "INSERT INTO todos" +
//       "  (title, todolist_id, username)" +
//       "  VALUES ($1, $2, $3)";

//     let result = await dbQuery(CREATE_TODO, title, todoListId, user);
//     return result.rowCount > 0;
//   }
...
//     return /duplicate key value violates unique constraint/.test(String(error));
//   }
//   async createTodoList(title, user) {
//     const CREATE_TODOLIST =
//       "INSERT INTO todolists (title, username) VALUES ($1, $2)";

//     try {
//       let result = await dbQuery(CREATE_TODOLIST, title, user);
//       return result.rowCount > 0;
//     } catch (error) {
//       if (this.isUniqueConstraintViolation(error)) return false;
//       throw error;
